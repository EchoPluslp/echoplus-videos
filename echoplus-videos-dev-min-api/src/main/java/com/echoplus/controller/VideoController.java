...
public class VideoController extends RedisBasicController {
    ...
    public EchoPlusJSONResult uploadFile(String userId, String bgmId,
        ...
        String filePath = System.lineSeparator() + userId + System.lineSeparator() + "video" + System.lineSeparator();
        String coverDbPath = System.lineSeparator() + userId + System.lineSeparator() + "video" + System.lineSeparator();
        if (userId == null) {
        ...
        try {
            if (file != null || file.getSize() > 0) {
                ...
                if (StringUtils.isNotBlank(filename)) {
                    ...
                    filePath += filename;
                    //截图的相对路径
                    coverDbPath = coverDbPath + System.lineSeparator() + filenamePrefix + ".jpg";
        ...
        if (StringUtils.isNotBlank(bgmId)) {
            ...
            filePath = System.lineSeparator() + userId + System.lineSeparator() + "video" + System.lineSeparator() + outputVideoName;
